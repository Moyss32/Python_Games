...
def calcular_distancia():
    ...
    for obstaculo in grupo_obstaculos:
        obstaculo_x = obstaculo.rect.x
        obstaculo_y = obstaculo.rect.y
        
        distancia = ((obstaculo_x - dino_x) ** 2 + (obstaculo_y - dino_y) ** 2) ** 0.5
    ...
    texto = font.render(f"Distância até o obstáculo mais próximo: {int(distancia_mais_proxima)}", True, (0, 0, 0))
